...
const BiographyPage = () => {
  return (
    <>
      <div tw="bg-green-400 h-96 w-full">
        <Link href="/" passHref>
          <a tw="text-black cursor-pointer text-lg font-medium fixed top-5 flex items-center left-10">
      ...
      <Container tw="mt-20 prose">
        ...
        <article tw="mt-10 text-lg text-justify pb-40">
          <p>
