...
const Contact = () => {
  return (
    <FullScreen
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, .2), rgba(0, 0, 0, .5)), url(/images/portrait4.jpeg)`,
      }}
    >
      <header tw="my-auto px-10 lg:px-96 text-black flex justify-end">
        <div>
          <h1 tw="text-3xl sm:text-4xl -mt-60 lg:text-5xl font-bold leading-normal">
            Contacto
          </h1>
